...
if(jQuery) (function($){
	...
	$.extend($.fn, {
		fileTree: function(o, h) {
			// Defaults
			if( !o ) var o = {};
			if( o.root == undefined ) o.root = './mp3';
						...
						files.forEach(function(f){
							...
							if (stats.isDirectory()) { 
								...
								if (f.substr(-4) === '.mp3' || f.substr(-4) === '.m4a' || f.substr(-5) === '.webm' || f.substr(-4) === '.wav' || f.substr(-4) === '.aac' || f.substr(-4) === '.ogg' || f.substr(-5) === '.opus') 
								{
									...
									//console.log(e);
									r += "<li class='draggable file ext_" + e + "'><span></span> <a href='#' data-src='"+ ff + "' rel='"+ ff + "'>" + f + "</a><i class='remove_list fright fa fa-remove' style='display:none'></i></li>";
								}
							}
						});
						r += '</ul>';
